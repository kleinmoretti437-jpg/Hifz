        ...
        const SPA_PAGES = ['beranda','fitur','fitur-a','fitur-b','fitur-c','fitur-d','fitur-alert','fitur-ruh','fitur-ruh-a','fitur-ruh-b','dashboard','tentang',
        ...
        function _showPage(normalId) {
            ...
            if (target) {
                ...
                if (normalId === 'dashboard') {
                    setTimeout(() => {
                        if (!window._dashChart) {
                            createMoodChart();
                        } else {
                            window._dashChart.resize();
                        }
                        animateProgressBars();
                    }, 300);
                }
...
// ===== next block =====
        ...
        (function() {
            ...
            function renderChart(data, days) {
                ...
                const totalPoints        = moodPointCount + skriningPointCount;
                ...
                if (chartNote) {
                    if (totalPoints < 3) {
                        chartNote.textContent = '✨ Terus isi data untuk melihat tren lengkap — grafik akan makin bermakna seiring waktu.';
                    } else if (moodPointCount < 2 || skriningPointCount < 2) {
                        chartNote.textContent = 'Hari tanpa data dibiarkan kosong agar grafik tidak memalsukan tren.';
                    } else {
